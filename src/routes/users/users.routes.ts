...
usersRoutes.post('/cadastro', (req, res) => { UsersController.store(req, res) });
...
usersRoutes.patch('/patch/:id', (req, res) => { UsersController.update(req, res) });

usersRoutes.delete('/del/:id', (req, res) => { UsersController.delete(req, res) });
